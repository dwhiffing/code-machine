export const LEVEL = [
  ...
  { key: 'Node-11', x: 957, y: 72 },
  { key: 'Wire-NegativeCell-3:Node-4', input: 'NegativeCell-3', output: 'Node-4', },
  ...
  { key: 'Wire-PositiveCell-2:Node-7', input: 'PositiveCell-2', output: 'Node-7', },
  { key: 'Wire-NegativeCell-3:Node-9', input: 'NegativeCell-3', output: 'Node-9', },
  { key: 'Wire-Node-9:Node-10', input: 'Node-9', output: 'Node-10' },
  { key: 'Wire-Magnet-8:Node-10', input: 'Magnet-8', output: 'Node-10' },
  { key: 'Wire-PositiveCell-2:Magnet-8', input: 'PositiveCell-2', output: 'Magnet-8', },
  { key: 'Wire-Switch-1:Magnet-8', input: 'Switch-1', output: 'Magnet-8' },
  { key: 'Wire-Node-7:Node-11', input: 'Node-7', output: 'Node-11' },
  { key: 'Wire-Node-6:Node-11', input: 'Node-6', output: 'Node-11' },
]
